...
import com.inkpot.app.data.FactoryDAO;
import com.inkpot.app.data.ILibretaDAO;
import com.inkpot.app.data.INotaDAO;
import com.inkpot.app.data.Nota;
import com.inkpot.app.data.NotasRepository;
import com.inkpot.app.data.room.NotaEntity;
...
public class ViewNotaActivityTest {
    ...
    public void muestraLaFechaDeModificacionCuandoEsDistinta() {
        Nota nota = crearNota("Titulo", "Contenido");
        NotaEntity entity = NotasDatabase.get(context, "inkpot").notaDao().getNotaById(nota.getId());
        entity.fechaModificacion = 946684800000L; // 01/01/2000 00:00 UTC
        NotasDatabase.get(context, "inkpot").notaDao().updateNota(entity);
